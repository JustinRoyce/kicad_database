...
from Kicad_DB_Config_File import Kicad_DB_Config_File
import glob2
import sys
import os
import pathlib
...
ROOT_CODE_DIR = os.path.dirname(__file__) ##< root code directory 

KICAD_DB_UI_NAME = "kicad_db_ui.ui"
KICAD_DB_UI_DIR = os.path.join(ROOT_CODE_DIR,"qt_ui_files")
KICAD_DB_UI_PATH = os.path.join(KICAD_DB_UI_DIR,KICAD_DB_UI_NAME) 

DB_GUI_CONFIG_NAME = "DB_GUI_config.ini"
DB_GUI_CONFIG_DIR = os.path.join(ROOT_CODE_DIR,"config_files")
DB_GUI_CONFIG_PATH = os.path.join(DB_GUI_CONFIG_DIR,DB_GUI_CONFIG_NAME)

LOCAL_CONFIG_FILTER = os.path.join(DB_GUI_CONFIG_PATH,"*.ini")


"""
GLOBAL GUI SETTINGS VARIABLES
"""
...
class Kicad_DB_GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        print(DB_GUI_CONFIG_PATH)
        self.kicad_db_config.set_config_file_path(config_file_path=DB_GUI_CONFIG_PATH)
